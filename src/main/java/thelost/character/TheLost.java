...
import thelost.cards.*;
import thelost.relics.HolyMantle;
import thelost.relics.SoulOfTheLost;

public class TheLost extends CustomPlayer {
    //Stats
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_LOST;
        @SpireEnum(name = "LOST_LIGHT_BLUE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "LOST_LIGHT_BLUE_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheLost() {
        super(NAMES[0], Enums.THE_LOST,
                new CustomEnergyOrb(orbTextures, characterPath("orb/vfx.png"), null), //Energy Orb
                new SpriterAnimation(characterPath("animation/thelost.scml"))); //Animation
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(MomsEye.ID);
        retVal.add(MomsEye.ID);
        retVal.add(HolyCard.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(HolyMantle.ID);
        retVal.add(SoulOfTheLost.ID);
    ...
    public void increaseMaxHp(int amount, boolean showEffect) {
        if (!AbstractDungeon.player.relics.contains(SoulOfTheLost.ID))
        {
    ...
    public int getAscensionMaxHPLoss() {
        return 0; //Max hp reduction at ascension 14+
    }
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA("TINGSHA", MathUtils.random(-0.2F, 0.2F));
