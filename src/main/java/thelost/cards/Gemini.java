...
import thelost.powers.GeminiPower;
import thelost.util.CardInfo;

import static thelost.BasicMod.makeID;

public class Gemini extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Gemini", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new GeminiPower(p, 1), 1));
    }
