...
public class RockBottom extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "RockBottom", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int ART = 999;

    private static final int cost_upg = 3;
