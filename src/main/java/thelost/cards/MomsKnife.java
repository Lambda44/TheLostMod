...
public class MomsKnife extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "MomsKnife", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int UPG_INCREASE = 3;
    ...
    public MomsKnife() {
        ...
        setMagic(INCREASE, UPG_INCREASE);
    }
