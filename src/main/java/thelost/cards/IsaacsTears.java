...
public class IsaacsTears extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "IsaacsTears", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int UPG_CRY = 2;
