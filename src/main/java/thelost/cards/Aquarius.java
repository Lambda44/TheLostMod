...
public class Aquarius extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Aquarius", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int TEARS = 4;
    private static final int TEARS_UPG = 2;
