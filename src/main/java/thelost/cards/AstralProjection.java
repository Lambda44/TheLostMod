...
public class AstralProjection extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "AstralProjection", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int INTANGIBLE = 3;
    private static final int INTANGIBLE_UPG = -1;
    ...
    public AstralProjection() {
        ...
        setMagic(INTANGIBLE, INTANGIBLE_UPG);
        setExhaust(true);
    }
