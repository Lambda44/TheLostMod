...
import thelost.powers.GodheadPower;
import thelost.powers.PerfectionPower;
import thelost.util.CardInfo;

import static thelost.BasicMod.makeID;

public class Godhead extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Godhead", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new GodheadPower(p, this.magicNumber), this.magicNumber));
    }
