...
public class Eraser extends BaseRelic{
    private static final String NAME = "Eraser";
    public static final String ID = makeID(NAME);
    private boolean cardsSelected = true;

    public Eraser() {
        super(ID, NAME, TheLost.Enums.CARD_COLOR, RelicTier.SHOP, LandingSound.FLAT);
    }
    ...
    public void deleteCards(ArrayList<AbstractCard> group) {
        ...
        AbstractCard theCard = group.get(0);
        String theName = theCard.name;
        CardGroup cg = AbstractDungeon.player.masterDeck;
        ArrayList<AbstractCard> deck = cg.group;

        int deckSize = cg.size();
